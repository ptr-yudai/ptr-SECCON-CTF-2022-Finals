...
TOKEN = 'test_token5'
TEAMID = 5
DELTA_CHECK  = datetime.timedelta(seconds=47)
DELTA_UPLOAD = datetime.timedelta(minutes=33)
DELTA_SUBMIT = datetime.timedelta(minutes=91)
DELTA_COMPILE = datetime.timedelta(minutes=7)
DELTA_EXECUTE = datetime.timedelta(minutes=11)
