...
TOKEN = 'test_token10'
TEAMID = 10
DELTA_CHECK  = datetime.timedelta(seconds=7)
DELTA_UPLOAD = datetime.timedelta(seconds=27)
DELTA_SUBMIT = datetime.timedelta(seconds=15)
DELTA_COMPILE = datetime.timedelta(seconds=32)
DELTA_EXECUTE = datetime.timedelta(seconds=47)
