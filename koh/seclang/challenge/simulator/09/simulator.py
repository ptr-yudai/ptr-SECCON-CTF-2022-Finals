...
DELTA_UPLOAD = datetime.timedelta(seconds=3)
DELTA_SUBMIT = datetime.timedelta(seconds=1)
DELTA_COMPILE = datetime.timedelta(seconds=1)
DELTA_EXECUTE = datetime.timedelta(seconds=1)
