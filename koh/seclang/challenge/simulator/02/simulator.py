...
TOKEN = 'test_token2'
TEAMID = 2
DELTA_CHECK  = datetime.timedelta(seconds=30)
DELTA_UPLOAD = datetime.timedelta(minutes=20)
DELTA_SUBMIT = datetime.timedelta(minutes=20)
DELTA_COMPILE = datetime.timedelta(minutes=1)
DELTA_EXECUTE = datetime.timedelta(minutes=5)
