...
def submit_correct_flag():
    ...
    rows = db.execute("SELECT flag FROM teams WHERE id = 7").fetchall() # !!!
    db.close()
...
TOKEN = 'test_token8'
TEAMID = 8
DELTA_CHECK  = datetime.timedelta(seconds=15)
DELTA_UPLOAD = datetime.timedelta(minutes=31)
DELTA_SUBMIT = datetime.timedelta(minutes=10)
DELTA_COMPILE = datetime.timedelta(minutes=2)
DELTA_EXECUTE = datetime.timedelta(minutes=2)
