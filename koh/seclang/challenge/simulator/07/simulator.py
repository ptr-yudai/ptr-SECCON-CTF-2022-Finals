...
TOKEN = 'test_token7'
TEAMID = 7
DELTA_CHECK  = datetime.timedelta(seconds=120)
DELTA_UPLOAD = datetime.timedelta(minutes=120)
DELTA_SUBMIT = datetime.timedelta(minutes=120)
DELTA_COMPILE = datetime.timedelta(minutes=20)
DELTA_EXECUTE = datetime.timedelta(minutes=20)
