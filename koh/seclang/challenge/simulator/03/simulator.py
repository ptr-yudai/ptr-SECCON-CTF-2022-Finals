...
DELTA_UPLOAD = datetime.timedelta(minutes=60)
DELTA_SUBMIT = datetime.timedelta(minutes=60)
DELTA_COMPILE = datetime.timedelta(minutes=10)
DELTA_EXECUTE = datetime.timedelta(minutes=10)
