...
TOKEN = 'test_token4'
TEAMID = 4
DELTA_CHECK  = datetime.timedelta(seconds=60)
DELTA_UPLOAD = datetime.timedelta(minutes=90)
DELTA_SUBMIT = datetime.timedelta(minutes=1)
DELTA_COMPILE = datetime.timedelta(minutes=5)
DELTA_EXECUTE = datetime.timedelta(minutes=3)
